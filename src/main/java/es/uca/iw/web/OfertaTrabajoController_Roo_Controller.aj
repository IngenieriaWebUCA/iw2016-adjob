...
import es.uca.iw.web.OfertaTrabajoController;
...
privileged aspect OfertaTrabajoController_Roo_Controller {
    ...
    void OfertaTrabajoController.addDateTimeFormatPatterns(Model uiModel) {
        ...
        uiModel.addAttribute("ofertaTrabajo_fecha_fin_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
