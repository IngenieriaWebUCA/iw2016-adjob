...
privileged aspect ExperienciaController_Roo_Controller {
    ...
    void ExperienciaController.addDateTimeFormatPatterns(Model uiModel) {
        uiModel.addAttribute("experiencia_fecha_inicio_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
        uiModel.addAttribute("experiencia_fecha_fin_date_format", DateTimeFormat.patternForStyle("M-", LocaleContextHolder.getLocale()));
    }
