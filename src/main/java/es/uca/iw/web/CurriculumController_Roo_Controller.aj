...
import es.uca.iw.web.CurriculumController;
...
privileged aspect CurriculumController_Roo_Controller {
    ...
    void CurriculumController.populateEditForm(Model uiModel, Curriculum curriculum) {
        ...
        uiModel.addAttribute("experienciacursoes", ExperienciaCurso.findAllExperienciaCursoes());
        uiModel.addAttribute("experienciaidiomas", ExperienciaIdioma.findAllExperienciaIdiomas());
        uiModel.addAttribute("experiencialaborals", ExperienciaLaboral.findAllExperienciaLaborals());
        uiModel.addAttribute("experienciatituloes", ExperienciaTitulo.findAllExperienciaTituloes());
